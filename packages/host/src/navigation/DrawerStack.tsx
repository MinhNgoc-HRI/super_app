    ...
    (props: DrawerContentComponentProps) => {
      return (
        <Box
          flex={1}
          overflow={'hidden'}
          style={[styles.drawerContent, {borderColor: theme.colors.main_2_bg}]}>
          <Box
  ...
  return (
    <Drawer.Navigator
      ...
      screenOptions={{
        headerShown: false,
        swipeEnabled: false,
        drawerActiveBackgroundColor: theme.colors.main_bg,
        ...
        drawerStyle: {
          flex: 1,
          width: '70%',
          backgroundColor: theme.colors.main_bg,
        },
        sceneContainerStyle: {
          backgroundColor: theme.colors.main_bg,
        },
